...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
<<<<<<< HEAD
            // First part of help message is specific to PxlCoin server / RPC client
            std::string strUsage = _("PxlCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  pxlcoin [options]                     " + "\n" +
                  "  pxlcoin [options] <command> [params]  " + _("Send command to -server or pxlcoin") + "\n" +
                  "  pxlcoin [options] help                " + _("List commands") + "\n" +
                  "  pxlcoin [options] help <command>      " + _("Get help for a command") + "\n";
=======
...
<<<<<<< HEAD
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "pxlcoin:"))
=======
...
{
<<<<<<< HEAD
    uiInterface.ThreadSafeMessageBox(str, _("PxlCoin"), CClientUIInterface::OK | CClientUIInterface::MODAL);
=======
...
{
<<<<<<< HEAD
    uiInterface.ThreadSafeMessageBox(str, _("PxlCoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
=======
...
<<<<<<< HEAD
        "  -conf=<file>           " + _("Specify configuration file (default: pxlcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: pxlcoin.pid)") + "\n" +
=======
...
>>>>>>> origin/master
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 46369 or testnet: 46370)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 46368)") + "\n" +
...
<<<<<<< HEAD
    // Make sure only a single pxlcoin process is using the data directory.
=======
...
>>>>>>> origin/master
    ...
    if (!lock.try_lock())
<<<<<<< HEAD
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s.  PxlCoin is probably already running."), GetDataDir().string().c_str()));
=======
...
>>>>>>> origin/master
    ...
    if (fDaemon)
<<<<<<< HEAD
        fprintf(stdout, "PxlCoin server starting\n");
=======
...
<<<<<<< HEAD
    // requested to kill pxlcoin-qt during the last operation. If so, exit.
=======
...
<<<<<<< HEAD
            strErrors << _("Error loading wallet.dat: Wallet requires newer version of PxlCoin") << "\n";
        else if (nLoadWalletRet == DB_NEED_REWRITE)
        {
            strErrors << _("Wallet needed to be rewritten: restart PxlCoin to complete") << "\n";
=======
