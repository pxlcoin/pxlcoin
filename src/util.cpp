...
<<<<<<< HEAD
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PxlCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\PxlCoin
    // Mac: ~/Library/Application Support/PxlCoin
    // Unix: ~/.pxlcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PxlCoin";
=======
...
{
<<<<<<< HEAD
    boost::filesystem::path pathConfigFile(GetArg("-conf", "pxlcoin.conf"));
=======
...
<<<<<<< HEAD
        return; // No pxlcoin.conf file is OK
=======
...
>>>>>>> origin/master
    ...
    {
<<<<<<< HEAD
        // Don't overwrite existing settings so command line settings override pxlcoin.conf
=======
...
{
<<<<<<< HEAD
    boost::filesystem::path pathPidFile(GetArg("-pid", "pxlcoin.pid"));
=======
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                if (!fMatch)
                {
                    fDone = true;
<<<<<<< HEAD
                    string strMessage = _("Warning: Please check that your computer's date and time are correct.  If your clock is wrong PxlCoin will not work properly.");
                    strMiscWarning = strMessage;
                    printf("*** %s\n", strMessage.c_str());
                    uiInterface.ThreadSafeMessageBox(strMessage+" ", string("PxlCoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION);
=======
